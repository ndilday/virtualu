...
//--------- BEGIN OF FUNCTION DynArray::deinit ------//
...
//---------- END OF FUNCTION DynArray::deinit --------//
...
int DynArray::compare(void* varChar,int varOff,char varType) {
	...
	if( bodyStr == (char*) varChar )            // the pointer is the same
	    ...
	    // m1strcmp with exact set off
	    return m.str_cmp(bodyStr, (char*) varChar);
...
//------------- End of function DynArray::bubble_sort --------------//
