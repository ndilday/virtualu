//Filename    : OGRPDYR.CPP
//Description : Object GraphDoubleBarYear
//Owner			: Kevin(Ho)
...
//-------- Begin of function GraphDoubleBarYear::GraphDoubleBarYear ----//
//!
GraphDoubleBarYear::GraphDoubleBarYear() {
    init_flag = 0;
    graph_bitmap = NULL;
}

//---------- End of function GraphDoubleBarYear::GraphDoubleBarYear ----//
...
//-------- Begin of function GraphDoubleBarYear::init --------//
//!
...
//!
void GraphDoubleBarYear::init(int x1, int y1, int x2, int y2,
...
//------------- End of function GraphDoubleBarYear::init -----------//

//-------- Begin of function GraphDoubleBarYear::deinit ------------//
//!
void GraphDoubleBarYear::deinit() {
    if (graph_bitmap) {
...
//------------- End of function GraphDoubleBarYear::deinit ---------//

//-------- Begin of function GraphDoubleBarYear::set_font ------------//
//!
void GraphDoubleBarYear::set_font(Font *fontPtr) {
    if (!init_flag)
	return;
...
//------------- End of function GraphDoubleBarYear::set_font ---------//

//-------- Begin of function GraphDoubleBarYear::calc_pos ------------//
//!
//! calculate screen positions
//! should be called after changing display settings
//!
void GraphDoubleBarYear::calc_pos() {
    if (legend_array) {
...
//------------ End of function GraphDoubleBarYear::calc_pos ---------//

//-------- Begin of function GraphDoubleBarYear::paint --------------//
//!
void GraphDoubleBarYear::paint() {
    if (transparent_flag) {
...
//------------- End of function GraphDoubleBarYear::paint -----------//

//-------- Begin of function GraphDoubleBarYear::refresh ------------//
//!
void GraphDoubleBarYear::refresh() {
    if (transparent_flag) {
...
//------------- End of function GraphDoubleBarYear::refresh ---------//

//---------- Begin of function GraphDoubleBarYear::draw_legend ------------//
//!
void GraphDoubleBarYear::draw_legend() {
    for (int i = 0; i < series_num; i++) {
...
//------------ End of function GraphDoubleBarYear::draw_legend ------------//

//---------- Begin of function GraphDoubleBarYear::draw_axis_label --------//
//!
void GraphDoubleBarYear::draw_axis_label() {
...
//------------ End of function GraphDoubleBarYear::draw_axis_label --------//

//---------- Begin of function GraphDoubleBarYear::find_scale -------------//
//!
void GraphDoubleBarYear::find_scale() {
...
//------------ End of function GraphDoubleBarYear::find_scale -------------//

//---------- Begin of function GraphDoubleBarYear::draw_scale -------------//
//!
void GraphDoubleBarYear::draw_scale() {
    find_scale();
	...
	font_ptr->center_put(
	    ...
	    xAxisPos+COMMON_OFFSET+4,
	    (int)(series_x1+(printing_offset+i)*x_axis_step)+maxLabelWidth/2+COMMON_OFFSET,
	    xAxisPos+COMMON_OFFSET+font_ptr->max_font_height+4,
...
//------------ End of function GraphDoubleBarYear::draw_scale -------------//

//---------- Begin of function GraphDoubleBarYear::draw_series ------------//
//!
void GraphDoubleBarYear::draw_series() {
    switch (data_type_flag) {
...
//------------ End of function GraphDoubleBarYear::draw_series ------------//

//---------- Begin of function GraphDoubleBarYear::draw_series_float ------------//
//!
void GraphDoubleBarYear::draw_series_float() {
    float *dataArray = (float *) data_array;
    short currX, currY;
    int barWidth = x_axis_step/(series_num+2);

    for (int i = 0; i < series_num; i++) {
	dataArray-=(info.graph_year-2);
	dataArray+=HISTORY_YEAR_COUNT;
	for (int j = 0; j < (info.graph_year-2); j++) {
...
//------------ End of function GraphDoubleBarYear::draw_series_float ------------//

//---------- Begin of function GraphDoubleBarYear::draw_series_double ------------//
//!
void GraphDoubleBarYear::draw_series_double() {
...
//------------ End of function GraphDoubleBarYear::draw_series_double ------------//

//---------- Begin of function GraphDoubleBarYear::draw_series_int ------------//
//!
void GraphDoubleBarYear::draw_series_int() {
	...
	dataArray+=HISTORY_YEAR_COUNT;
	for (int j = 0; j < (info.graph_year-2); j++) {
	    currX = (short)(series_x1 + j * x_axis_step + i * barWidth + 3*barWidth/2);
	    if (x_axis_pos)
...
//------------ End of function GraphDoubleBarYear::draw_series_int ------------//

//---------- Begin of function GraphDoubleBarYear::draw_series_long ------------//
//!
void GraphDoubleBarYear::draw_series_long() {
...
//---------- Begin of function GraphDoubleBarYear::draw_value -------------------//
//!
void GraphDoubleBarYear::draw_value(void *value, int color, short x, short y, int dataType) {
    char *valueString;
    switch (data_type_flag) {
    case DATA_FLOAT:
...
//---------- End of function GraphDoubleBarYear::draw_value -------------------//
