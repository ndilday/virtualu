...
//!Structure describing particular sound effect and filename where sound is
//!stored.
struct SEInfo {
...
//!Structure used for searching through sound effects using a subject verb
//!to find the subject_id.
struct SEInfoIndex {
    char  subject_type;
    char  dummy;
    short subject_id;
...
//!Structure used for searching through sound effects using the sound type
//!to find the subject_id.
struct SETypeIndex {
    char  subject_type;
    char  dummy;
...
//!Sound Effect Resouce. Loads sound effects and used by SECtrl to search
//!for matching effect.
class SERes {
public:
    int   init_flag;
