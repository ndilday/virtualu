//Filename    : OGRPHMTH.CPP
//Description : Object GraphMonth	(Month-based)
//Owner			: Kevin(Ho)
...
//-------- Begin of function GraphMonth::GraphMonth ----//
//!
...
//---------- End of function GraphMonth::GraphMonth ----//
...
//-------- Begin of function GraphMonth::init --------//
//!
...
//!
void GraphMonth::init(int x1, int y1, int x2, int y2,
...
//------------- End of function GraphMonth::init -----------//

//-------- Begin of function GraphMonth::deinit ------------//
//!
void GraphMonth::deinit() {
    if (graph_bitmap) {
...
//------------- End of function GraphMonth::deinit ---------//

//-------- Begin of function GraphMonth::set_font ------------//
//!
void GraphMonth::set_font(Font *fontPtr) {
    if (!init_flag)
	return;
...
//------------- End of function GraphMonth::set_font ---------//

//-------- Begin of function GraphMonth::calc_pos ------------//
//!
//! calculate screen positions
//! should be called after changing display settings
//!
void GraphMonth::calc_pos() {
    if (legend_array) {
    ...
    series_x2 = graph_x2 - 34 - COMMON_OFFSET*16;
    series_y2 = graph_y1 + graph_height - COMMON_OFFSET*3 - (font_ptr->max_font_height);
}

//------------ End of function GraphMonth::calc_pos ---------//

//-------- Begin of function GraphMonth::paint --------------//
//!
void GraphMonth::paint() {
    if (transparent_flag) {
...
//------------- End of function GraphMonth::paint -----------//

//-------- Begin of function GraphMonth::refresh ------------//
//!
void GraphMonth::refresh() {
    if (transparent_flag) {
...
//------------- End of function GraphMonth::refresh ---------//

//---------- Begin of function GraphMonth::draw_legend ------------//
//!
void GraphMonth::draw_legend() {
    for (int i = 0; i < series_num; i++) {
...
//------------ End of function GraphMonth::draw_legend ------------//

//---------- Begin of function GraphMonth::draw_axis_label --------//
//!
void GraphMonth::draw_axis_label() {
...
//------------ End of function GraphMonth::draw_axis_label --------//

//---------- Begin of function GraphMonth::find_scale -------------//
//!
void GraphMonth::find_scale() {
    //	double data , maxVal = 0.0,minVal = 0.0;
    double data = 0.0, maxVal = 0.0,minVal = 0.0;   //## chea try to fix the freeze
...
//------------ End of function GraphMonth::find_scale -------------//

//---------- Begin of function GraphMonth::draw_scale -------------//
//!
void GraphMonth::draw_scale() {
    find_scale();
...
//------------ End of function GraphMonth::draw_scale -------------//

//---------- Begin of function GraphMonth::draw_series ------------//
//!
void GraphMonth::draw_series() {
    switch (data_type_flag) {
...
//------------ End of function GraphMonth::draw_series ------------//

//---------- Begin of function GraphMonth::draw_series_float ------------//
//!
void GraphMonth::draw_series_float() {
...
//------------ End of function GraphMonth::draw_series_float ------------//

//---------- Begin of function GraphMonth::draw_series_double ------------//
//!
void GraphMonth::draw_series_double() {
...
//------------ End of function GraphMonth::draw_series_double ------------//

//---------- Begin of function GraphMonth::draw_series_int ------------//
//!
void GraphMonth::draw_series_int() {
...
//------------ End of function GraphMonth::draw_series_int ------------//

//---------- Begin of function GraphMonth::draw_series_long ------------//
//!
void GraphMonth::draw_series_long() {
...
//---------- Begin of function GraphMonth::draw_value -------------------//
//!
void GraphMonth::draw_value(void *value, int color, short x, short y, int dataType) {
    char *valueString;
    switch (data_type_flag) {
    case DATA_FLOAT:
...
//---------- End of function GraphMonth::draw_value -------------------//
