//Filename    : OGRPSTRI.CPP
//Description : Object GraphSpecialTrimester	(Trimester-based)
//Owner			: Kevin(Ho)
...
//-------- Begin of function GraphSpecialTrimester::GraphSpecialTrimester ----//
//!
GraphSpecialTrimester::GraphSpecialTrimester() {
    init_flag = 0;
    graph_bitmap = NULL;
}

//---------- End of function GraphSpecialTrimester::GraphSpecialTrimester ----//
...
//-------- Begin of function GraphSpecialTrimester::init --------//
//!
...
//!
void GraphSpecialTrimester::init(int x1, int y1, int x2, int y2,
...
//------------- End of function GraphSpecialTrimester::init -----------//

//-------- Begin of function GraphSpecialTrimester::deinit ------------//
//!
void GraphSpecialTrimester::deinit() {
    if (graph_bitmap) {
...
//------------- End of function GraphSpecialTrimester::deinit ---------//

//-------- Begin of function GraphSpecialTrimester::set_font ------------//
//!
void GraphSpecialTrimester::set_font(Font *fontPtr) {
    if (!init_flag)
	return;
...
//------------- End of function GraphSpecialTrimester::set_font ---------//

//-------- Begin of function GraphSpecialTrimester::calc_pos ------------//
//!
//! calculate screen positions
//! should be called after changing display settings
//!
void GraphSpecialTrimester::calc_pos() {
    if (legend_array) {
...
//------------ End of function GraphSpecialTrimester::calc_pos ---------//

//-------- Begin of function GraphSpecialTrimester::paint --------------//
//!
void GraphSpecialTrimester::paint() {
    if (transparent_flag) {
...
//------------- End of function GraphSpecialTrimester::paint -----------//

//-------- Begin of function GraphSpecialTrimester::refresh ------------//
//!
void GraphSpecialTrimester::refresh() {
    if (transparent_flag) {
...
//------------- End of function GraphSpecialTrimester::refresh ---------//

//---------- Begin of function GraphSpecialTrimester::draw_legend ------------//
//!
void GraphSpecialTrimester::draw_legend() {
    for (int i = 0; i < series_num; i++) {
...
//------------ End of function GraphSpecialTrimester::draw_legend ------------//

//---------- Begin of function GraphSpecialTrimester::draw_axis_label --------//
//!
void GraphSpecialTrimester::draw_axis_label() {
...
//------------ End of function GraphSpecialTrimester::draw_axis_label --------//

//---------- Begin of function GraphSpecialTrimester::find_scale -------------//
//!
void GraphSpecialTrimester::find_scale() {
...
//------------ End of function GraphSpecialTrimester::find_scale -------------//

//---------- Begin of function GraphSpecialTrimester::draw_scale -------------//
//!
void GraphSpecialTrimester::draw_scale() {
    find_scale();
	...
	case DATA_FLOAT:
	case DATA_DOUBLE:
	    font_ptr->right_put(series_x1-COMMON_OFFSET, ycheck-font_news.max_font_height/2, m.format(scaleValue,num_format));
	    break;
	case DATA_INT:
	case DATA_LONG:
	    font_ptr->right_put(series_x1-COMMON_OFFSET, ycheck-font_news.max_font_height/2, m.format(long(scaleValue),num_format));
	}
    }
    ...
    if(info.graph_trimester<data_trimester_shown)
	data_trimester_shown=info.graph_trimester;
    ...
    //	double actual_start = actual_end-(double)(info.graph_trimester)/3.0;
    ...
    //------ Draw x-axis -------//
    for (i = 0; i < scale_trimester_shown ; i += displayInc) {
	int this_x;
	...
	for(int j=series_y1;j<series_y2+COMMON_OFFSET;j+=8)
	    vga_back.bar(
		(int)(series_x1+(info.graph_trimester-this_trimester_indicator-1)*x_axis_step),
		j,
		(int)(series_x1+(info.graph_trimester-this_trimester_indicator-1)*x_axis_step),
		j+4,
		axis_color);
...
//------------ End of function GraphSpecialTrimester::draw_scale -------------//

//---------- Begin of function GraphSpecialTrimester::draw_series ------------//
//!
void GraphSpecialTrimester::draw_series() {
    switch (data_type_flag) {
...
//------------ End of function GraphSpecialTrimester::draw_series ------------//

//---------- Begin of function GraphSpecialTrimester::draw_series_float ------------//
//!
void GraphSpecialTrimester::draw_series_float() {
    float *dataArray = (float *) data_array;
    short prevX, prevY, currX, currY;

    for (int i = 0; i < series_num; i++) {
	dataArray-=info.graph_trimester;
	...
	for (int j = 1; j < info.graph_trimester; j++) {
...
//------------ End of function GraphSpecialTrimester::draw_series_float ------------//

//---------- Begin of function GraphSpecialTrimester::draw_series_double ------------//
//!
void GraphSpecialTrimester::draw_series_double() {
...
//------------ End of function GraphSpecialTrimester::draw_series_double ------------//

//---------- Begin of function GraphSpecialTrimester::draw_series_int ------------//
//!
void GraphSpecialTrimester::draw_series_int() {
...
//------------ End of function GraphSpecialTrimester::draw_series_int ------------//

//---------- Begin of function GraphSpecialTrimester::draw_series_long ------------//
//!
void GraphSpecialTrimester::draw_series_long() {
...
//---------- Begin of function GraphSpecialTrimester::draw_value -------------------//
//!
void GraphSpecialTrimester::draw_value(void *value, int color, short x, short y, int dataType) {
    char *valueString;
    switch (data_type_flag) {
    case DATA_FLOAT:
...
//---------- End of function GraphSpecialTrimester::draw_value -------------------//
