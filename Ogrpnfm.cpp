//Filename    : OGRPNFM.CPP
//Description : Object GraphNonFinancialMonth	(Month-based)
//Owner			: Kevin(Ho)
...
//-------- Begin of function GraphNonFinancialMonth::GraphNonFinancialMonth ----//
//!
GraphNonFinancialMonth::GraphNonFinancialMonth() {
    init_flag = 0;
    graph_bitmap = NULL;
}

//---------- End of function GraphNonFinancialMonth::GraphNonFinancialMonth ----//
...
//-------- Begin of function GraphNonFinancialMonth::init --------//
//!
...
//!
void GraphNonFinancialMonth::init(int x1, int y1, int x2, int y2,
...
//------------- End of function GraphNonFinancialMonth::init -----------//

//-------- Begin of function GraphNonFinancialMonth::deinit ------------//
//!
void GraphNonFinancialMonth::deinit() {
    if (graph_bitmap) {
...
//------------- End of function GraphNonFinancialMonth::deinit ---------//

//-------- Begin of function GraphNonFinancialMonth::set_font ------------//
//!
void GraphNonFinancialMonth::set_font(Font *fontPtr) {
    if (!init_flag)
	return;
...
//------------- End of function GraphNonFinancialMonth::set_font ---------//

//-------- Begin of function GraphNonFinancialMonth::calc_pos ------------//
//!
//! calculate screen positions
//! should be called after changing display settings
//!
void GraphNonFinancialMonth::calc_pos() {
    if (legend_array) {
...
//------------ End of function GraphNonFinancialMonth::calc_pos ---------//

//-------- Begin of function GraphNonFinancialMonth::paint --------------//
//!
void GraphNonFinancialMonth::paint() {
    if (transparent_flag) {
...
//------------- End of function GraphNonFinancialMonth::paint -----------//

//-------- Begin of function GraphNonFinancialMonth::refresh ------------//
//!
void GraphNonFinancialMonth::refresh() {
    if (transparent_flag) {
...
//------------- End of function GraphNonFinancialMonth::refresh ---------//

//---------- Begin of function GraphNonFinancialMonth::draw_legend ------------//
//!
void GraphNonFinancialMonth::draw_legend() {
    for (int i = 0; i < series_num; i++) {
...
//------------ End of function GraphNonFinancialMonth::draw_legend ------------//

//---------- Begin of function GraphNonFinancialMonth::draw_axis_label --------//
//!
void GraphNonFinancialMonth::draw_axis_label() {
...
//------------ End of function GraphNonFinancialMonth::draw_axis_label --------//

//---------- Begin of function GraphNonFinancialMonth::find_scale -------------//
//!
void GraphNonFinancialMonth::find_scale() {
...
//------------ End of function GraphNonFinancialMonth::find_scale -------------//

//---------- Begin of function GraphNonFinancialMonth::draw_scale -------------//
//!
void GraphNonFinancialMonth::draw_scale() {
    find_scale();
    ...
    double actual_start = actual_end-(double)(info.graph_month_passed)/12.0;
    // if finanical year
    // draw yr.i at i+(8.0/12.0) which is > actual_start
    // then i > L-(8.0/12.0)
    double financialYearOffset = (8.0f/12.0f);      // for year start in sept
	...
	for(int j=series_y1;j<series_y2+COMMON_OFFSET;j+=8)
	    vga_back.bar(
		(int)(series_x1+(info.graph_month_passed-this_month_indicator-1)*x_axis_step),
		j,
		(int)(series_x1+(info.graph_month_passed-this_month_indicator-1)*x_axis_step),
		j+4,
		axis_color);
...
//------------ End of function GraphNonFinancialMonth::draw_scale -------------//

//---------- Begin of function GraphNonFinancialMonth::draw_series ------------//
//!
void GraphNonFinancialMonth::draw_series() {
    switch (data_type_flag) {
...
//------------ End of function GraphNonFinancialMonth::draw_series ------------//

//---------- Begin of function GraphNonFinancialMonth::draw_series_float ------------//
//!
void GraphNonFinancialMonth::draw_series_float() {
    float *dataArray = (float*)data_array;
    short prevX, prevY, currX, currY;

    for (int i = 0; i < series_num; i++) {
	dataArray-=info.graph_month_passed;
	...
	for (int j = 1; j < info.graph_month_passed; j++) {
...
//------------ End of function GraphNonFinancialMonth::draw_series_float ------------//

//---------- Begin of function GraphNonFinancialMonth::draw_series_double ------------//
//!
void GraphNonFinancialMonth::draw_series_double() {
...
//------------ End of function GraphNonFinancialMonth::draw_series_double ------------//

//---------- Begin of function GraphNonFinancialMonth::draw_series_int ------------//
//!
void GraphNonFinancialMonth::draw_series_int() {
...
//------------ End of function GraphNonFinancialMonth::draw_series_int ------------//

//---------- Begin of function GraphNonFinancialMonth::draw_series_long ------------//
//!
void GraphNonFinancialMonth::draw_series_long() {
...
//---------- Begin of function GraphNonFinancialMonth::draw_value -------------------//
//!
void GraphNonFinancialMonth::draw_value(void *value, int color, short x, short y, int dataType) {
    char *valueString;
    switch (data_type_flag) {
    case DATA_FLOAT:
...
//---------- End of function GraphNonFinancialMonth::draw_value -------------------//
