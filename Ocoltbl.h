...
// ---------- define RGBColor --------//
//!Structure containing the blue, green, and red values of a color. Used
//!for color remap of the ColorTable.
struct RGBColor {
    BYTE  red;
    BYTE  green;
    BYTE  blue;
...
// ---------- define HSVColor --------//
//!Structure containing the hue, saturation, and value of a color. Used for
//!color remap of the ColorTable.
struct HSVColor {
    double hue;
    double saturation;
    double brightness;
