//Filename    : OGRPHTRI.CPP
//Description : Object GraphTrimester	(Trimester-based)
//Owner			: Kevin(Ho)
...
//-------- Begin of function GraphTrimester::GraphTrimester ----//
//!
GraphTrimester::GraphTrimester() {
    init_flag = 0;
    graph_bitmap = NULL;
}

//---------- End of function GraphTrimester::GraphTrimester ----//
...
//-------- Begin of function GraphTrimester::init --------//
//!
...
//!
void GraphTrimester::init(int x1, int y1, int x2, int y2,
...
//------------- End of function GraphTrimester::init -----------//

//-------- Begin of function GraphTrimester::deinit ------------//
//!
void GraphTrimester::deinit() {
    if (graph_bitmap) {
...
//------------- End of function GraphTrimester::deinit ---------//

//-------- Begin of function GraphTrimester::set_font ------------//
//!
void GraphTrimester::set_font(Font *fontPtr) {
    if (!init_flag)
	return;
...
//------------- End of function GraphTrimester::set_font ---------//

//-------- Begin of function GraphTrimester::calc_pos ------------//
//!
//! calculate screen positions
//! should be called after changing display settings
//!
void GraphTrimester::calc_pos() {
    if (legend_array) {
...
//------------ End of function GraphTrimester::calc_pos ---------//

//-------- Begin of function GraphTrimester::paint --------------//
//!
void GraphTrimester::paint() {
    if (transparent_flag) {
...
//------------- End of function GraphTrimester::paint -----------//

//-------- Begin of function GraphTrimester::refresh ------------//
//!
void GraphTrimester::refresh() {
    if (transparent_flag) {
...
//------------- End of function GraphTrimester::refresh ---------//

//---------- Begin of function GraphTrimester::draw_legend ------------//
//!
void GraphTrimester::draw_legend() {
    for (int i = 0; i < series_num; i++) {
...
//------------ End of function GraphTrimester::draw_legend ------------//

//---------- Begin of function GraphTrimester::draw_axis_label --------//
//!
void GraphTrimester::draw_axis_label() {
...
//------------ End of function GraphTrimester::draw_axis_label --------//

//---------- Begin of function GraphTrimester::find_scale -------------//
//!
void GraphTrimester::find_scale() {
...
//------------ End of function GraphTrimester::find_scale -------------//

//---------- Begin of function GraphTrimester::draw_scale -------------//
//!
void GraphTrimester::draw_scale() {
    find_scale();
...
//------------ End of function GraphTrimester::draw_scale -------------//

//---------- Begin of function GraphTrimester::draw_series ------------//
//!
void GraphTrimester::draw_series() {
    switch (data_type_flag) {
...
//------------ End of function GraphTrimester::draw_series ------------//

//---------- Begin of function GraphTrimester::draw_series_float ------------//
//!
void GraphTrimester::draw_series_float() {
...
//------------ End of function GraphTrimester::draw_series_float ------------//

//---------- Begin of function GraphTrimester::draw_series_double ------------//
//!
void GraphTrimester::draw_series_double() {
...
//------------ End of function GraphTrimester::draw_series_double ------------//

//---------- Begin of function GraphTrimester::draw_series_int ------------//
//!
void GraphTrimester::draw_series_int() {
...
//------------ End of function GraphTrimester::draw_series_int ------------//

//---------- Begin of function GraphTrimester::draw_series_long ------------//
//!
void GraphTrimester::draw_series_long() {
...
//---------- Begin of function GraphTrimester::draw_value -------------------//
//!
void GraphTrimester::draw_value(void *value, int color, short x, short y, int dataType) {
    char *valueString;
    switch (data_type_flag) {
    case DATA_FLOAT:
...
//---------- End of function GraphTrimester::draw_value -------------------//
