//Filename    : ALL.H
//Description : General-purpose header file, include Mem & Error
...
#ifdef DEBUG
// 0 for null
#define err_when(cond)   if(cond) err.internal(0,__FILE__, __LINE__)
// 0 for null
#define err_here()       err.internal(0,__FILE__, __LINE__)
