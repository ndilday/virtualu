//Filename    : OGRPH_PY.CPP
//Description : Object GraphPerformanceIndicatorYear
//Owner			: Kevin(Ho)
...
//-------- Begin of function GraphPerformanceIndicatorYear::GraphPerformanceIndicatorYear ----//
//!
GraphPerformanceIndicatorYear::GraphPerformanceIndicatorYear() {
    init_flag = 0;
    grapha_bitmap = NULL;
}

//---------- End of function GraphPerformanceIndicatorYear::GraphPerformanceIndicatorYear ----//
...
//-------- Begin of function GraphPerformanceIndicatorYear::init --------//
//!
...
//!
void GraphPerformanceIndicatorYear::init(int x1, int y1, int x2, int y2,
...
//------------- End of function GraphPerformanceIndicatorYear::init -----------//

//-------- Begin of function GraphPerformanceIndicatorYear::deinit ------------//
//!
void GraphPerformanceIndicatorYear::deinit() {
    if (grapha_bitmap) {
...
//------------- End of function GraphPerformanceIndicatorYear::deinit ---------//

//-------- Begin of function GraphPerformanceIndicatorYear::set_font ------------//
//!
void GraphPerformanceIndicatorYear::set_font(Font *fontPtr) {
    if (!init_flag)
	return;
...
//------------- End of function GraphPerformanceIndicatorYear::set_font ---------//

//-------- Begin of function GraphPerformanceIndicatorYear::calc_pos ------------//
//!
//! calculate screen positions
//! should be called after changing display settings
//!
void GraphPerformanceIndicatorYear::calc_pos() {
...
//------------ End of function GraphPerformanceIndicatorYear::calc_pos ---------//

//-------- Begin of function GraphPerformanceIndicatorYear::paint --------------//
//!
void GraphPerformanceIndicatorYear::paint() {
    if (transparent_flag) {
	vga.use_back();
...
//------------- End of function GraphPerformanceIndicatorYear::paint -----------//

//-------- Begin of function GraphPerformanceIndicatorYear::refresh ------------//
//!
void GraphPerformanceIndicatorYear::refresh() {
    //	vga.use_back();
...
//------------- End of function GraphPerformanceIndicatorYear::refresh ---------//

//---------- Begin of function GraphPerformanceIndicatorYear::find_scale -------------//
//!
void GraphPerformanceIndicatorYear::find_scale() {
...
//------------ End of function GraphPerformanceIndicatorYear::find_scale -------------//

//---------- Begin of function GraphPerformanceIndicatorYear::draw_scale -------------//
//!
void GraphPerformanceIndicatorYear::draw_scale() {
    find_scale();
    //------ Draw y-axis -------//
...
//------------ End of function GraphPerformanceIndicatorYear::draw_scale -------------//

//---------- Begin of function GraphPerformanceIndicatorYear::draw_series ------------//
//!
void GraphPerformanceIndicatorYear::draw_series() {
    switch (data_type_flag) {
...
//------------ End of function GraphPerformanceIndicatorYear::draw_series ------------//

//---------- Begin of function GraphPerformanceIndicatorYear::draw_series_float ------------//
//!
void GraphPerformanceIndicatorYear::draw_series_float() {
...
//------------ End of function GraphPerformanceIndicatorYear::draw_series_float ------------//

//---------- Begin of function GraphPerformanceIndicatorYear::draw_series_double ------------//
//!
void GraphPerformanceIndicatorYear::draw_series_double() {
...
//------------ End of function GraphPerformanceIndicatorYear::draw_series_double ------------//

//---------- Begin of function GraphPerformanceIndicatorYear::draw_series_int ------------//
//!
void GraphPerformanceIndicatorYear::draw_series_int() {
...
//------------ End of function GraphPerformanceIndicatorYear::draw_series_int ------------//

//---------- Begin of function GraphPerformanceIndicatorYear::draw_series_long ------------//
//!
void GraphPerformanceIndicatorYear::draw_series_long() {
...
//---------- Begin of function GraphPerformanceIndicatorYear::draw_value -------------------//
//!
void GraphPerformanceIndicatorYear::draw_value(void *value, int color, short x, short y, int dataType) {
    char *valueString;
    switch (data_type_flag) {
    case DATA_FLOAT:
...
//---------- End of function GraphPerformanceIndicatorYear::draw_value -------------------//
