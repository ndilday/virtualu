...
#include "controlw.h"
    ...
    //!Flag for controlling the persistence of newmat computations.
	...
	int Length() {                              // length of row or column
	    return length;
	}
    ...
    //!MatrixColX is an alternative to MatrixCol where the complete column is
    //!stored externally. Defined in newmat library.
