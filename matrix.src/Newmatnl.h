...
namespace NEWMAT {
    ...
    /*
      ...
      //!Non-linear optimization Class. Part of the newmat library. FindMaximum2
      //!is the basic optimization strategy when one is doing an optimisation
      //!where one has first derivatives and estimates of the second derivatives.
      //!See FindMaximum2.cpp for details and examples.
      class FindMaximum2
      ...
      //!Class NonLinearLeastSquares is derived from FindMaximum2. This provides
      //!the functions that calculate function values and derivatives. Defined in
      //!newmat library.
    ...
    */
    ...
    //!One of a series of classes for non-linear optimization. The prototype
    //!for a Real function of a ColumnVector and an integer. Part of newmat
    //!library.
    class R1_Col_I_D {
    ...
    //!This class is the prototype class for calculating the log-likelihood.
    //!Defined in newmat library. It is assumed that first derivatives are
    //!available and something like the Fisher Information or
    //!variance/covariance matrix of the first derivatives or minus the matrix
    //!of second derivatives is available. This matrix must be positive
    //!definite.
    class LL_D_FI {
    protected:
    ...
    //!The class for doing the maximum likelihood estimation. Extends
    //!FindMaximum2.
