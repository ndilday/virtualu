...
//!Structure containing header information for Text resourses managed by
//!ResTxt such as letters and messages.
struct TxtIndex {
    enum { TITLE_LEN=100, PICT_NAME_LEN=8 };
...
//!Text resourses (.RTX extensions), such as letters and messages.
class ResTxt {
public:
    int        rec_count;
