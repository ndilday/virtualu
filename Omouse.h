...
//!Struture containing coordinates, number of clicks, and timestamp of a
//!mouse click.
...
/*
//!Structure containing details of a mouse event, including type, time
//!coordinates and special keys pressed.
...
//!Driver independent Mouse Handling Object.
class Mouse {
public:
    char   init_flag;
	...
	IDirectInputDevice8* di_mouse_device, *di_keyb_device;
    ...
    enum {                                        // No. of events can be stored in buffer
...
public:
    ...
    void  init(HINSTANCE, HWND, IDirectInput8* createdDirectInput=0);
    void  deinit();
