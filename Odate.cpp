...
//!                        (default : 0)
//! [int]  showDate = show date or not
//!                        (default : 1)
//!
//! Return : <char*> the formated date string
//!
char* DateInfo::date_str( long julianDate, int shortMonthStr, int showDate) {
    int    year, month, day, nDays, maxDays ;
    long   totalDays ;
...
char* DateInfo::month_str(int monthNo) {
    return month_str_array[monthNo-1];
}
