//Filename    : OGRPH_PM.CPP
//Description : Object GraphPerformanceIndicatorMonth
//Owner			: Kevin(Ho)
...
//-------- Begin of function GraphPerformanceIndicatorMonth::GraphPerformanceIndicatorMonth ----//
//!
GraphPerformanceIndicatorMonth::GraphPerformanceIndicatorMonth() {
    init_flag = 0;
    grapha_bitmap = NULL;
}

//---------- End of function GraphPerformanceIndicatorMonth::GraphPerformanceIndicatorMonth ----//
...
//-------- Begin of function GraphPerformanceIndicatorMonth::init --------//
//!
...
//!
void GraphPerformanceIndicatorMonth::init(int x1, int y1, int x2, int y2,
...
//------------- End of function GraphPerformanceIndicatorMonth::init -----------//

//-------- Begin of function GraphPerformanceIndicatorMonth::deinit ------------//
//!
void GraphPerformanceIndicatorMonth::deinit() {
    if (grapha_bitmap) {
...
//------------- End of function GraphPerformanceIndicatorMonth::deinit ---------//

//-------- Begin of function GraphPerformanceIndicatorMonth::set_font ------------//
//!
void GraphPerformanceIndicatorMonth::set_font(Font *fontPtr) {
    if (!init_flag)
	return;
...
//------------- End of function GraphPerformanceIndicatorMonth::set_font ---------//

//-------- Begin of function GraphPerformanceIndicatorMonth::calc_pos ------------//
//!
//! calculate screen positions
//! should be called after changing display settings
//!
void GraphPerformanceIndicatorMonth::calc_pos() {
...
//------------ End of function GraphPerformanceIndicatorMonth::calc_pos ---------//

//-------- Begin of function GraphPerformanceIndicatorMonth::paint --------------//
//!
void GraphPerformanceIndicatorMonth::paint() {
    if (transparent_flag) {
	vga.use_back();
...
//------------- End of function GraphPerformanceIndicatorMonth::paint -----------//

//-------- Begin of function GraphPerformanceIndicatorMonth::refresh ------------//
//!
void GraphPerformanceIndicatorMonth::refresh() {
    //	vga.use_back();
...
//------------- End of function GraphPerformanceIndicatorMonth::refresh ---------//

//---------- Begin of function GraphPerformanceIndicatorMonth::find_scale -------------//
//!
void GraphPerformanceIndicatorMonth::find_scale() {
...
//------------ End of function GraphPerformanceIndicatorMonth::find_scale -------------//

//---------- Begin of function GraphPerformanceIndicatorMonth::draw_scale -------------//
//!
void GraphPerformanceIndicatorMonth::draw_scale() {
    find_scale();
    //------ Draw y-axis -------//
    ...
    int currY;
    if (x_axis_pos)
	currY = series_y2 - short(((float(max_scale)) * float(series_y2-series_y1) / float(max_scale*2)));
    else
	currY = series_y2;

    //	if (x_axis_pos)
    //		vga_back.bar(series_x1, series_y2+COMMON_OFFSET*2, series_x2-COMMON_OFFSET, series_y2+COMMON_OFFSET*2+1, axis_color);
    //	else
    vga_back.bar(series_x1, currY, series_x2-COMMON_OFFSET, currY+1, axis_color);

    x_axis_step = (double)(series_x2-series_x1) / (*data_num-1);
}

//------------ End of function GraphPerformanceIndicatorMonth::draw_scale -------------//

//---------- Begin of function GraphPerformanceIndicatorMonth::draw_series ------------//
//!
void GraphPerformanceIndicatorMonth::draw_series() {
    switch (data_type_flag) {
...
//------------ End of function GraphPerformanceIndicatorMonth::draw_series ------------//

//---------- Begin of function GraphPerformanceIndicatorMonth::draw_series_float ------------//
//!
void GraphPerformanceIndicatorMonth::draw_series_float() {
...
//------------ End of function GraphPerformanceIndicatorMonth::draw_series_float ------------//

//---------- Begin of function GraphPerformanceIndicatorMonth::draw_series_double ------------//
//!
void GraphPerformanceIndicatorMonth::draw_series_double() {
...
//------------ End of function GraphPerformanceIndicatorMonth::draw_series_double ------------//

//---------- Begin of function GraphPerformanceIndicatorMonth::draw_series_int ------------//
//!
void GraphPerformanceIndicatorMonth::draw_series_int() {
...
//------------ End of function GraphPerformanceIndicatorMonth::draw_series_int ------------//

//---------- Begin of function GraphPerformanceIndicatorMonth::draw_series_long ------------//
//!
void GraphPerformanceIndicatorMonth::draw_series_long() {
...
//---------- Begin of function GraphPerformanceIndicatorMonth::draw_value -------------------//
//!
void GraphPerformanceIndicatorMonth::draw_value(void *value, int color, short x, short y, int dataType) {
    char *valueString;
    switch (data_type_flag) {
    case DATA_FLOAT:
...
//---------- End of function GraphPerformanceIndicatorMonth::draw_value -------------------//
