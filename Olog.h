...
//!Logging class for debugging. Define DEBUG_LOG_GLOBAL to turn loggin on
//!everywhere. To use locally, define DEBUG_LOG_LOCAL before #include
//!<OLOG.H>: 1 to force enable debug log of that module, even though
//!DEBUG_LOG_GLOBAL is 0, -1 to force disable debug log of that module,
//!even though DEBUG_LOG_GLOBAL is 1, 0 to follow DEBUG_LOG_GLOBAL.
class Log {
private:
    enum { LOG_VERSION = 12 };
