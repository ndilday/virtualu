...
//!Class for capturing keyboard/mouse events from user - non blocking.
class GetA {
public:
    short x;
    short y;
...
//!Class for capturing a group or an area of keyboard/mouse events from
//!user - non blocking.
class GetAGroup {
public:
    int    geta_num;
