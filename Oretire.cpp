...
static char retirement_report_init_flag;
//------- Begin of function RetirementReport::RetirementReport -----------//
//!
RetirementReport::RetirementReport() {
    init();
}

//--------- End of function RetirementReport::RetirementReport -----------//
...
//------- Begin of function RetirementReport::deinit ---------------//
//!
void RetirementReport::deinit() {
    retirement_report_init_flag = 0;
}

//--------- End of function RetirementReport::deinit ---------------//

//------- Begin of function RetirementReport::init -----------------//
//!
void RetirementReport::init() {
    retirement_report_init_flag = 0;
}

//--------- End of function RetirementReport::init -----------------//

//---------- Begin of function RetirementReport::eval_letter_report ------------//
//! You can set the value of RetirementReport::topic_id before running this functions
void RetirementReport::retirement_report(int refreshFlag) {
	...
	if(retirement_report_init_flag )
	    deinit();
...
int RetirementReport::retirement_detect() {
    int tab1=REPORT_X1,tab2=REPORT_X1+100,
