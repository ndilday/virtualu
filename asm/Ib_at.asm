...
;----------- BEGIN OF FUNCTION IMGbltWAreaTrans ------------
;
...
;
; Syntax : IMGbltWAreaTrans( imageBuf, pitch, desX, desY, bitmapBuf, srcX1, srcY1, srcX2, srcY2 )
;
...
;-------------------------------------------------
		...
		PUBLIC    IMGbltWAreaTrans
IMGbltWAreaTrans PROC   	  imageBuf, pitch, desX, desY, bitmapPtr, srcX1, srcY1, srcX2, srcY2
		LOCAL	  srcLineDiff
		STARTPROC
...
@@skipPoint:
		...
		ENDPROC
IMGbltWAreaTrans ENDP

;----------- END OF FUNCTION IMGbltWAreaTrans ----------
